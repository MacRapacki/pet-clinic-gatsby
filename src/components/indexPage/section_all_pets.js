      ...
      <section className={style.section}>
        ...
        <div className={style.wrapper}>
          ...
          <p className={style.description}>
            ...
            zwierzętom i jest otwarty 24 godziny na dobę w nagłych przypadkach.
            Dzięki doświadczeniu zdobytemu przez lata zaawansowanego szkolenia
            nasi weterynarze radzą sobie z najtrudniejszymi warunkami medycznymi
            i chirurgicznymi. Nasi specjaliści wykorzystują innowacyjne
            procedury, w połączeniu z tradycyjnymi, sprawdzonymi metodami,
            nowoczesnym sprzętem oraz najnowocześniejszymi lekami i terapiami,
            aby zdiagnozować i leczyć stan Twojego pupila.
          </p>
        </div>
        ...
        <div className={style.wrapper}>
          ...
          <p className={style.description}>
            ...
            Naprawdę cenimy Twoją opinię w procesie podejmowania decyzji. Nasza
            zdolność do wspierania doświadczeń edukacyjnych w celu zaspokojenia
            Twoich indywidualnych potrzeb nie ma sobie równych.
          </p>
        </div>
      </section>{" "}
    </>
